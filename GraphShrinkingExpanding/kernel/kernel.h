...
extern void perform_induction_step_expanding(int block_size, int thread_size, cudaStream_t stream, int* d_sampled_vertices, int* d_offsets, int* d_indices, Edge* d_edge_data_expanding, int* d_edge_count_expanding);
